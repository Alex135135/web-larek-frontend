...
Данный проект представляет собой интернет-магазин, который был реализован в виде веб-приложения. Он разработан с применением паттерна проектирования MVP (Model-View-Presenter).
...
### class EventEmitter
Класс который отвечает за работу со слушателями и событиями.
...
Базовый абстрактный класс, базовая модель, чтобы можно было отличить ее от простых объектов с данными
